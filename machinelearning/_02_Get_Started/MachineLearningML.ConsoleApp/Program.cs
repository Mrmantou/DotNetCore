...
namespace MachineLearningML.ConsoleApp
{
    class Program
    {
        ...
        private const string DATA_FILEPATH = @"D:\mygit\DotNetCore\machinelearning\_02_Get_Started\myMLApp\wikipedia-detox-250-line-data.tsv";
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"\n\nActual Sentiment: {sampleData.Sentiment} \nPredicted Sentiment: {predictionResult.Prediction} {predictionResult.Score}\n\n");
